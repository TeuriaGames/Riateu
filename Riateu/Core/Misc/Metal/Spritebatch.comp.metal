...
, constant _mslBufferSizes& _buffer_sizes [[user(fake0)]]
    ...
    metal::float4x4 origin = metal::float4x4(metal::float4(1.0, 0.0, 0.0, 0.0), metal::float4(0.0, 1.0, 0.0, 0.0), metal::float4(0.0, 0.0, 1.0, 0.0), metal::float4(-(compData.origin.x), -(compData.origin.y), compData.depth, 1.0));
    ...
    metal::float4 topLeft = metal::float4(compData.position.x, compData.position.y, compData.depth, 1.0);
    metal::float4 topRight = metal::float4(compData.position.x + width, compData.position.y, compData.depth, 1.0);
    metal::float4 bottomLeft = metal::float4(compData.position.x, compData.position.y + height, compData.depth, 1.0);
    metal::float4 bottomRight = metal::float4(compData.position.x + width, compData.position.y + height, compData.depth, 1.0);
